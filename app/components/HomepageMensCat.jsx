...
export default function HomepageMensCat() {
    const { carts, products, loading } = useContext(CartContext);

    const mensCloth = products.filter(p => p.category === "men's clothing").slice(0, 3);
    ...
    return (
        <section className="bg-slate-700 py-12 px-4 relative overflow-hidden">
            <div className="container max-w-screen-xl mx-auto px-4 relative z-10">
                <h2 className="text-4xl font-bold mb-8 text-center text-white dark:text-zinc-100">Men's Collection</h2>
